...
This is a library for the "Arduino":http://pololu.com/catalog/product/2191 that interfaces with ST LPS25H and LPS331AP pressure sensors on Pololu boards. It makes it simple to read the raw pressure data from these boards:
